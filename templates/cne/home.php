...
<img style='width: 35%;margin-bottom:4%;' src="/estaticos/source/imgs/cne_orig.png">
	<p class="text-justify ident">
		...
		<p>Caso não consiga ver as regras a baixo, clicke no link ao lado <a href="/estaticos/source/docs/cne_regras_in.pdf" target="_blank"><strong><u>Regras</u></strong></a></p>
	</p>
	<div class='regras'>
		<h3>Regras</h3>	 
