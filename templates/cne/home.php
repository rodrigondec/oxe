...
<img style='width: 35%;margin-bottom:4%;' src="/estaticos/source/imgs/cne_orig.png">
	...
	<div class='regras'>
		<h3>Regras</h3>	 
		<embed src="/estaticos/source/docs/cne_regras_in.pdf">
		<div>
		<?php 
	...
	<p>Caso não consiga ver as regras a cima, clicke no botão ao lado => <a class='btn btn-info' href="/estaticos/source/docs/cne_regras_in.pdf" target="_blank">Regras</a></p>
</div>
<?php  
	if(count($_POST) > 0) {
		ob_clean();
		header('LOCATION: /index.php/cne/inscricao');
	}
